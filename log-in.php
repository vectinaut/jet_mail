...
<head>
  ...
  <script defer src="assets/js/log-in.js"></script>
</head>
<body>
  ...
  <main class="main">
    <section class="log-in">
      <div class="container-limit log-in-container flex">
        ...
        <form action="log-in.php" class="log-in-form" method="post">
          ...
          <button name="button-log" class="log-in__btn btn-resert" type="submit">
            Войти
          </button>
        </form>

        <a href="registration.php" class="log-in__btn-small">
          Зарегистрироваться
        </a>
      </div>
    </section>
